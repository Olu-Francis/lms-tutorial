...
const CourseIdPage = async ({
  ...
  return (
    <div>
      ...
      {isLocked && (
        <Banner
          label="You are yet to purchased the course! Please do so to access this chapter."
          variant="warning"
        />
      )}
      <div className="flex flex-col max-w-4xl mx-auto pb-20">
            ...
            <div>
                <div className="p-4 flex flex-col md:flex-row items-center justify-between">
                    ...
                    {purchase ? (
                        <CourseProgressButton chapterId={params.chapterId} courseId={params.courseId} nextChapterId={nextChapter?.id}
